...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    # charter §11: no ungated update on the parked branch (a Desktop Update
    # click reset 59 fleet commits on 2026-09-02). Must stay the FIRST
    # statement — everything below mutates the checkout.
