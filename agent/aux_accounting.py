    ...
    *provider*/*base_url* reflect the originally-resolved route.
    ...
    try:
        ...
        session_db.record_auxiliary_usage(
            ...
            # Aggregator attribution: ``response`` is the raw SDK object, so these come
            # off the wire shape rather than NormalizedResponse. Auxiliary calls
            # (compression, titles, vision, MoA slots) are a real slice of spend and
            # were equally unattributed until 2026-09-05.
